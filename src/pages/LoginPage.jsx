...
export default function LoginPage() {
  ...
  return (
    <body className="bg-palette-secondary font-family-karla h-screen">
      ...
      <form action="/auth" method="post" className="w-full flex flex-wrap">
          ...
          <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <form className="flex flex-col pt-3 md:pt-8">
              <div className="flex flex-col pt-4">
                ...
                <input type="email" name="user_email" id="email" placeholder="your@email.com" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
              </div>

              <div className="flex flex-col pt-4">
                <span htmlFor="password" className="text-lg text-palette-primary font-bold">Senha</span>
                <input type="password" name="user_password" id="password" placeholder="Password" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
              </div>
